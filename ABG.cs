...
namespace ABG
{
    ...
    /// </summary>
    public class respABG
    {
        public enum enABG_O2 : short
        {
            Normal, Mild_Hypoxemia, Moderate_Hypoxemia, Sever_Hypoxemia
        }
        public enum enABG : short
        {
            Acute_Respiratory_Acidosis, Acute_Respiratory_Alkalosis,
        ...
        enABG_O2 myPO2Analysis = enABG_O2.Normal;
        ...
        public respABG(decimal PH, short CO2, short HCO3, short PO2)
        {
            myCO2 = CO2;
            myHCO3 = HCO3;
            myPH = PH;
        ...
        private string OxygenCheck()
        {
            ...
            {
                result = "Normal PO2. ";
                myPO2Analysis = enABG_O2.Normal;
            }
            else if (myPO2 >= 60)
            {
                result = "Mild Hypoxemia PO2. ";
                myPO2Analysis = enABG_O2.Mild_Hypoxemia;
            }
            else if (myPO2 >= 40)
            {
                result = "Moderate Hypoxemia PO2. ";
                myPO2Analysis = enABG_O2.Moderate_Hypoxemia;
            }
            else if (myPO2 < 40)
            {
                result = "Sever Hypoxemia PO2. ";
                myPO2Analysis = enABG_O2.Sever_Hypoxemia;
            }
        ...
        public enABG MyABGAnalysis
        {
            get;
            private set;
        }

        public enABG_O2 MyPO2Analysis
        {
            get;
            private set;
        }
